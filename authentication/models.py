...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    starting_date = models.DateTimeField(_('Starting Date'), help_text='Subsidy Percentage', auto_now_add=True)
    subsidy_date = models.DateTimeField(_('Starting Date'), help_text='Subsidy Percentage', auto_now_add=True)
